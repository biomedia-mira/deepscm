...
from deepscm.distributions.transforms.affine import LearnedAffineTransform, ConditionalAffineTransform
...
class ConditionalImageFlowSEM(BaseFlowSEM):
...
MODEL_REGISTRY[ConditionalImageFlowSEM.__name__] = ConditionalImageFlowSEM
